...
#define COPY_FROM_60HZ_TABLE(TABLE_NAME, ANTI_BANDING_SETTING) \
	...
	COPY_FROM_60HZ_TABLE (sr030pc50_fps_auto_normal_regs, 60hz);
	COPY_FROM_60HZ_TABLE (sr030pc50_fps_auto_Dark_regs, 60hz);
...
#define IS_SAME_NUM_OF_ROWS(TABLE_NAME) \
	...
	if ( !IS_SAME_NUM_OF_ROWS(sr030pc50_fps_auto_normal_regs) ) return (-11);
	if ( !IS_SAME_NUM_OF_ROWS(sr030pc50_fps_auto_Dark_regs) ) return (-12);
